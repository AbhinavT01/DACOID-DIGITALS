...
import AndroidLarge2 from "./pages/AndroidLarge21";
import AndroidLarge21 from "./pages/AndroidLarge2";
import AndroidLarge3 from "./pages/AndroidLarge3";
import AndroidLarge31 from "./pages/AndroidLarge31";
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/android-large-8" element={<AndroidLarge21 />} />
      <Route path="/android-large-9" element={<AndroidLarge3 />} />
      <Route path="/android-large-5" element={<AndroidLarge31 />} />
